        ...
        while (run) { //무한 반복시키기 위해 while(boolean타입) 사용
            ...
            switch (selectNo) { //번호를 선택하여 그 번호를 실행하게 switch문 사용
                case 1://목록_1번을 누르면 실행될 코드들
                    ...
                    for (int i=num-1; i>=0; i--){//원래 게시글 배열을 검사하면서 게시글 번호에 맞게 임시 배열에 정리 
                        if(boardArray[i][0] != null){
                          ...
                          //배열은 주소값으로 메모리에 저장된다. 주소값은 배열의 각 요소가 메모리에 저장되어 있는 위치를 의미한다.
                          //두 배열이 가리키는 주소가 같다면 같은 데이터를 참조하고 있는 것이다.
                ...
                case 2://생성
                    ...
                    int nulNum = 0;//현재 비어있는 배열값중 가장 작은값 체크
                    ...
                    boardArray[nulNum] = temp;//비어있는 가장 작은방에 게시글 추가 
                ...
                case 3: //읽기(Read)
                  ...
                  //게시글 읽기 후 조회수 증가
                    ...
                    System.out.print("no."+(Integer.parseInt(boardArray[findNum-1][0])+1)+"\n" +" 제목  : "+ boardArray[findNum-1][1]+"\n"+" 내용  : "+
                            boardArray[findNum-1][2]+"\n"+"글쓴이  : "+ boardArray[findNum-1][3]+"\n"+"조회수  : "+boardArray[findNum-1][4]);
                    System.out.println("");
...
//                        }
                ...
                case 5: // 삭제
                    ...
                    boardArray[delNum-1] = deltemp; // 수정하기!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
